...
Software at [Obedience Corp](https://obediencecorp.com). I work on the parts of the stack that have to stay on the machine: local inference, voice pipelines, and the campaign tooling we use to keep agent work legible.
